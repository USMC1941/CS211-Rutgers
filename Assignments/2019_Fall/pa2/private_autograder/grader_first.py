...
first_weight = {"testA.txt": 2.5, "testB.txt": 5.0, "testC.txt": 2.5, "testD.txt": 2.5,
                "testE.txt": 2.5, "testF.txt": 2.5, "testG.txt": 2.5, "testH.txt": 2.5, "testI.txt": 2.5}
...
if __name__ == '__main__':
    ...
    print "Your score for first is ", total_score, "/50"
