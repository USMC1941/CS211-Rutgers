...
def file_grade(dirname):
    ...
    for testfile in sorted(os.listdir(test_dir)):
        ...
        try:
            ...
            run_command("./%s %s %s >> %s" % (dirname, test_dir + testfile, test_dir +
                                              testfile1, resultfile), timeout=runtime[dirname], user_program=True)
...
if __name__ == '__main__':
    ...
    print "Your TOTAL SCORE = ", Total_score, "/66.0 for the public test cases"
